...
#pragma warning disable RS2008 // enable analyzer release tracking
	...
	public static readonly DiagnosticDescriptor NonNullableHookArgument = new(
		...
		messageFormat: "'{0}' should be marked nullable; Celeste/Everest aren't nullable-aware, so parameters other than `orig` and `self` should be maybe-null to catch potential null reference bugs",
		category: "Usage",
		defaultSeverity: DiagnosticSeverity.Warning,
		isEnabledByDefault: true
	);
